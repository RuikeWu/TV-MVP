function covint = covintel(n,p,eigensamples,eigensamples2,r1,theta1,r2,theta2)
c=p/n;
z1=r1.*exp(1i.*theta1);
z2=r2.*exp(1i.*theta2);
...
for j=1:p   %calculate m(z) 
    ...
    stieltjes2=stieltjes2+1./(eigensamples2(j)-z2);
    deristieltjes1=deristieltjes1+1./((eigensamples(j)-z1).^2);
    deristieltjes2=deristieltjes2+1./((eigensamples2(j)-z2).^2);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%limitvar%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
covint=-z1.*z2.^2.*(4.*deulstj1.*deulstj2./(ulstj1-ulstj2).^2).*z1.*z2;
